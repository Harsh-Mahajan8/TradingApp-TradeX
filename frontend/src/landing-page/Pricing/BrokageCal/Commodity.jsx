          ...
          <div className="row text-[#383838] border-b p-3 border-zinc-300 mx-1">
            ...
            <div className="col-10">
              <div className="row ms-2 justify-between">
                <div className="col-6">Commodity futures</div>
                <div className="col-6">Commodity options</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row my-[2rem] ps-2">
          ...
          <div className="col-10">
            <div className="row justify-between">
              ...
              <div className="col-6"> 0.05% on sell side</div>
            </div>
          </div>
        </div>
        ...
        <div className="row my-[2rem] ps-2">
          ...
          <div className="col-10">
            <div className="row justify-between">
              ...
              <div className="col-6"> 0.003% or ₹300 / crore on buy side</div>
            </div>
          </div>
        </div>
      </div>
